  ...
  return (
    <>
      ...
      <div className="prose mx-auto">
        ...
        <h2>1. Terms</h2>
        <p>
          By accessing this Website, accessible from postpostcard.com, you are
        ...
        <p>
          ...
          materials on PostPostcard's Website for personal, non-commercial
        ...
        <ul>
          ...
          <li>
            attempt to reverse engineer any software contained on PostPostcard's
            Website;
          </li>
          <li>
        ...
        <h2>3. Disclaimer</h2>
        <p>
          All the materials on PostPostcard’s Website are provided "as is".
          PostPostcard makes no warranties, may it be expressed or implied,
          therefore negates all other warranties. Furthermore, PostPostcard does
        ...
        <p>
          The materials appearing on PostPostcard’s Website may include
          technical, typographical, or photographic errors. PostPostcard will
          not promise that any of the materials in this Website are accurate,
          complete, or current. PostPostcard may change the materials contained
          on its Website at any time without notice. PostPostcard does not make
          any commitment to update the materials.
        </p>
        <h2>6. Links</h2>
        <p>
          PostPostcard has not reviewed all of the sites linked to its Website
          and is not responsible for the contents of any such linked site. The
          presence of any link does not imply endorsement by PostPostcard of the
          site. The use of any linked website is at the user’s own risk.
        </p>
        <h2>7. Site Terms of Use Modifications</h2>
        <p>
          PostPostcard may revise these Terms of Use for its Website at any time
        ...
        <p>
          Any claim related to PostPostcard's Website shall be governed by the
